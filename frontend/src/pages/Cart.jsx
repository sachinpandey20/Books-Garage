...
const Cart = () => {
  ...
  return (
    <div className="bg-zinc-900 px-4 md:px-12 min-h-screen py-8 flex flex-col justify-between">
      {!Cart ? (
      ...
      {Cart && Cart.length > 0 && (
        <div className="mt-4 w-full flex items-center justify-end">
          <div className="p-4 bg-zinc-800 rounded">
            ...
            <div className="mt-4 w-full flex items-center justify-between text-xl text-zinc-200">
